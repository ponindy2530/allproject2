...
var CalculatorComponent = (function () {
    function CalculatorComponent() {
        ...
        this.expression = '=';
        this.percentPattern = new RegExp('[0-9]+[+-]{1}[0-9]+(%)$');
        this.percentPattern2 = new RegExp('^(%){1}$');
    }
    ...
    CalculatorComponent.prototype.clearLcd = function () {
        this.lcdValue = "";
    };
    CalculatorComponent.prototype.evaluate = function () {
        ...
        if (this.percentPattern.test(this.lcdValue)) {
            ...
            var ar = this.lcdValue.split('+').join(',').split('-').join(',').split('%');
            console.log(ar);
            var tt = ar[0].split(',');
            var op = void 0;
            ...
            var pc = Number(tt[1]) / 100 * Number(tt[0]);
            var result = tt[0] + op + pc; // tt[1];
